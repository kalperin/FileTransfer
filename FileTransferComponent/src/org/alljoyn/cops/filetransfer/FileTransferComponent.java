...
/**
 * The File Transfer Component is a library that provides application developers with a
 ...
 * instances of the File Transfer Component and specify a different AllJoyn session for each. 
...
public class FileTransferComponent 
{
	 ...
	 * constructs an instance of the FileTransferComponent without an AllJoyn session.
	...
	/**
	 * FileTransferComponent()
	 * constructs an instance of the FileTransferComponent and uses the provided
	 ...
	 */
	public FileTransferComponent(BusAttachment busAttachment, int sessionID)
	{		
	 ...
	 * File Transfer Component (FTC). The user will still be able to use most of the core
