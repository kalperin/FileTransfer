...
/**
 * The SendManager (SM) is a major piece of the File Transfer Component. The SMs major
...
public class SendManager implements SendManagerListener
{
	 ...
	 * @param fsa  instance of FileSystemAbstraction component
	 * @param pm  instance of PermissionsManager component
	 */
	...
	**/
	...
	/**
	 * resetState()
	 * is called by the File Transfer Component when the user specifies a new AllJoyn
